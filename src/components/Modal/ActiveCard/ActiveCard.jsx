...
import { updateCardInBoard } from '~/redux/activeBoard/activeBoardSlide'
...
function ActiveCard() {
  ...
  const callApiUpdateCard = async (updateData) => {
    ...
    dispatch(updateCurrentActiveCard(updateCard.value))

    dispatch(updateCardInBoard(updateCard.value))
